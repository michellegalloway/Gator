...
//In this two functions the two control regions are taken at the left and at the right of the central region, all with the same widths
	...
	void SetDataSpect(TH1F* MCAspec){mp_sampleSpect=MCAspec;};
	
	void SetBackgroundSpect(TH1F* MCAspec){mp_backgroundSpect=MCAspec;};
	
	vector<LineStruct> *mv_lines;//Created by default as an empty vector
	
	TH1F *mp_sampleSpect; //Spectrum in MCA and not rebinned or rescaled
	TH1F *mp_backgroundSpect; //Spectrum in MCA and not rebinned or rescaled
